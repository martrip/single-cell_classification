...
It was a model that can predict 12 classes and was trained on unbalanced data. <br>
The feature importance of each cell type was extracted from the model and the 20 most influential features were plotted.
These values represent the impact each gene has in deciding if a cell belongs to a certain cell type or not. <br>
